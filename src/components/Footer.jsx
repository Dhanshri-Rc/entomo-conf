        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                <p className="font-serif font-bold text-xl leading-none">ICISZ 2026</p>
            ...
            <p className="text-green-100/80 text-sm leading-relaxed max-w-xs font-sans">
              International Conference on Insect Science &amp; Zoology 2026 — Advancing the frontiers of entomology through global scientific collaboration.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm font-sans">
              ...
              <li className="flex items-start gap-2">
                ...
                <div>
                  <a href="mailto:info@icisz2026.org" className="text-green-300 hover:text-white transition-colors">
                    info@icisz2026.org
                  </a>
                </div>
              </li>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-green-100/50 text-xs font-sans">
            © 2026 ICISZ — International Conference on Insect Science &amp; Zoology. All rights reserved.
          </p>
